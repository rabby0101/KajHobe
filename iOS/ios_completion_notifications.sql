-- iOS App Completion Request Notification System
-- This handles the two-step completion approval process used by the iOS app
...
-- Update notifications table to support completion notification types
DO $$
BEGIN
    ...
    -- Add new constraint with completion notification types
...
-- Verify the changes
SELECT 
    'iOS completion request notification triggers created successfully!' as message,
