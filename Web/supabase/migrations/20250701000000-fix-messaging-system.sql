-- Fix messaging system for job applications and negotiations

-- First, add is_service_provider field to profiles if it doesn't exist
...
-- Update messages table to support offers and negotiations
...
-- Update RLS policies for jobs to show apply button only to service providers
